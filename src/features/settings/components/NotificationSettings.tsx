...
export const NotificationSettings = () => {
    ...
    const notifItems = [
        { icon: Mail, label: t.settings.emailNotif, sub: t.settings.emailSub, value: email, toggle: () => setEmail(v => !v) },
        { icon: MessageSquare, label: t.settings.smsNotif, sub: t.settings.smsSub, value: sms, toggle: () => setSms(v => !v) },
        { icon: Monitor, label: t.settings.dashboardAlerts, sub: t.settings.dashboardSub, value: dashboard, toggle: () => setDashboard(v => !v) },
    ]
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-3 pt-2 border-t border-[var(--bg-border)]">
                    ...
                    <div className="flex-1">
                        <p className="text-[11px] font-semibold text-[var(--text-primary)]">{t.settings.escalation}</p>
                        <p className="text-[10px] text-[var(--text-muted)]">{t.settings.escalationSub}</p>
                    </div>
