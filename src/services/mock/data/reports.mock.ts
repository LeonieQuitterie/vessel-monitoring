...
export const mockReports: Report[] = [
  ...
  { id: 'RPT-007', name: 'Bearing Inspection Report',   dateGenerated: '2024-05-24 14:00', type: 'Condition',    status: 'completed' },
  { id: 'RPT-008', name: 'Power Consumption Analysis',  dateGenerated: '2024-05-24 09:30', type: 'Efficiency',   status: 'completed' },
  { id: 'RPT-009', name: 'Weekly Safety Report',        dateGenerated: '2024-05-23 17:00', type: 'Compliance',   status: 'completed' },
  { id: 'RPT-010', name: 'Lube Oil System Report',      dateGenerated: '2024-05-23 11:15', type: 'Maintenance',  status: 'completed' },
  { id: 'RPT-011', name: 'Hull Inspection Summary',     dateGenerated: '2024-05-22 15:45', type: 'Condition',    status: 'scheduled' },
  { id: 'RPT-012', name: 'Monthly Performance Report',  dateGenerated: '2024-05-22 08:00', type: 'Performance',  status: 'completed' },
]
